...
\tablesection{Program Chair}
	...
	\conf{VISSOFT}{`14, '19'}
	{IEEE Working Conference on Software Visualization} % 14 was ERA \eratrack
...
\tablesection{Conference PC Member}
	...
	\conf {SANER}{`20, `19, `18, `16, `15}{22nd Int. Conf. on Software Analysis, Evolution and Reengineering}

	\conf {MSR}{`15, `14}{Int. Conf. om Mining Software Repositories}

	\conf {ICSE}{`14, `12}{Int. Conf.  on Software Engineering \tdtrack}

	\conf {WCRE}{ `14, `13, `12}{Int. Conf.  on Reverse Engineering}

	\conf {ICSME}{`14, `12, `11}{Int. Conf. on Software Maintenance \& Evolution\tderatrack}
