...
\paragraph{Organizer, co-organizer}
FAMOOSR 2010

%:- Programme Chair:
\paragraph{Programme Chair}
WCRE Tool Demo Track Chair, 2011
CSMR Tool Demo Track Chair, 2012

%:- PC Member:
\paragraph{PC Member}
WCRE 2012\footnote {International Conference on Reverse Engineering}, IWSECO 
...
\begin{tabular}{p{1cm}p{12cm}}
2011 	& University of California, Irvine. {\em Reverse Engineering Software Ecosystems.}\\
2010 	& PL 2010, The 3rd Summer School on Programming Languages, Chile. {\em Software Ecosystem Analysis.} \\
	& Faculty of Informatics, University of Lugano. Lecture on {\em Architecture Recovery.}\\
	& Pleiad Lab, University of Chile. Lecture on {\em Reverse Engineering Software Ecosystems.}\\
2008	& 2nd International Workshop on Advanced Software Development Tools and Techniques (Wasdett2 2008), Beijing (China). Invited Talk on {\em Web-based visualization tools for reverse engineering.}\\
2007 	& IBM TJ Watson Research Center. {\em The Small Project Observatory.}\\
\end{tabular}
