...
\paragraph {Project Reviewer:}
Expert evaluator for the European Commission in the FP7 Programme.
...
\item Erik Aeschlimann. \emph {Tools for Analyzing a PL1 Ecosystem}. Master Thesis, University of Bern \emph{(in progress).}
...
\item Lile Hattori, Alberto Bacchelli, Michele Lanza, and Mircea Lungu. \emph{Erase and rewind ø Learning by replaying examples.} In Software Engineering Education and Training, Conference on 0 p. 558, 2011.
