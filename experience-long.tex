...
\begin{tabular}{r p{12cm}}
	...
	% {Co-founder \& Mentor}
	% {Working towards promoting non-formal lifelong education by mentoring individual students, financially supporting learners, and organizing events. Based on the belief that {\em ``to whom much is given, much is expected''}. 
	% % Currently co-organizing an educational camp for Kenyan kids for 2016. {\em (ledweb.github.io)}
	% }
